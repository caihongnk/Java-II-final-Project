 ...
 */
// initializes the user repository with the file path and file name
//to the file that will store our LinkedIn users. 
//off of your home directory That file will live in a folder called, Java2, located
